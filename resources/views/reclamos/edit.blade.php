					    		...
					    		<table  style="undefined;table-layout: fixed; width: 100%">
									...
									<col style="width: 55%">
									  ...
									  <tr>
									    ...
									    <td class="tg-xldj" colspan="2" > 
									    	<input type="date" class="form-control" readonly  name="fecha_reclamo" value=<?php if(!isset( $recla->fecha_reclamo)){$fechaActual = date('Y-m-d');
									    																echo $fechaActual;}  else echo $recla->fecha_reclamo;
																										?>>
									  ...
									  <tr>
									    ...
									    <td class="tg-xldj" colspan="2"  >
									    	<input type="checkbox" class="form-control"  <?php if (@$recla->estado=="ACTIVO") echo "checked";else if(@$recla->estado=="DESACTIVADO") echo "deschecked ";else echo "checked  disabled";?>  name="estado" value="ACTIVO"  >
									    </td>
									  </tr>
