...
<table class="Parte1" align="center">
  <tr>
    ...
    <th class="" style="width:80%; border:0px;"> 
      ...
      <tr style="" >
        <td class="" colspan="2" style="text-align:left width:30%;"><span style="font-size: 10pt;">SEÑOR(A):  {{$ser->nombre}}{{"   "}}{{$ser->apellido_pate}}{{"  "}}{{$ser->apellido_mate}}</span></td>
        <td class=""  style="text-align:left width:30%;"><span style="font-size: 10pt;">DNI : {{$ser->cliente_id}}</span></td>
        <td class=""  style="text-align:left width:40%;"><span style="font-size: 10pt;">ESTADO : <strong style="color:red;">{{$ser->estado}}</strong></span></td>
      </tr>
      <tr>
    ...
    ?>
        ...
        <tr>
       <th class="" style="" colspan="3" align="center"><span style="font-size: 8pt;">FECHA DE RECLAMO</span></th>
    </tr>
    <?php
      $partes1 = explode("-", $ser->fecha_reclamo);
        $a1=$partes1[0];
        $b1=$partes1[1];
        $c1=$partes1[2];
    ?>
